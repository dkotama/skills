...
```markdown
# Tech Decisions — <PROJECT_NAME>

> Generated by monorepo-init. Update as decisions evolve.

## Package Management

| Platform | Manager | Workspace Tool |
|----------|---------|----------------|
| <platform> | <pnpm/bun/uv/go mod/pub> | <turborepo/pnpm-workspaces/none> |

## Code Quality

| Platform | Linter + Formatter | Git Hooks |
|----------|--------------------|-----------|
| <platform> | <Biome / ESLint+Prettier / Ruff / golangci-lint> | Lefthook |

## Testing

| Platform | Unit | E2E | Coverage Target |
|----------|------|-----|-----------------|
| <platform> | <Vitest/Jest/pytest/go test/flutter_test> | <Playwright/Detox/httptest/integration_test> | ≥ 80% |

## Auth

**Strategy:** <None / Clerk / Supabase Auth / Auth0 / Built-in>
**Applies to:** <platform(s)>

## Database

**Engine:** <PostgreSQL / MySQL / MongoDB / None>
**Local dev:** <docker-compose / managed / N/A>
**ORM per platform:**
- `<platform>`: <Drizzle / Prisma / SQLAlchemy / GORM / None>

## Admin

**Strategy:** <None / Strapi built-in / Separate admin/ platform / Third-party>

## Shared Packages

**Strategy:** <None — fully isolated / packages/types / packages/ui / Turborepo workspace>

## CI/CD

**Provider:** <GitHub Actions / GitLab CI / None>
**Triggers:** PR open + push to <MAIN_BRANCH>

## Plugins & Libraries

<For each platform, one subsection:>
